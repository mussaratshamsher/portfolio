...
{/* section 1  */}
   ...
   <div>  <h1 className='text-lg md:text-2xl'><b>My Story</b></h1>
    <p className='my-5 text-justify indent-10 md:indent-20'> I possess a strong foundation in web development, with expertise in several key technologies.
         ...
         with utility-first styling. My knowledge of TypeScript empowers me to develop dynamic and
          ...
          high-quality user experiences.I am also proficient in Python, which allows me to develop robust applications 
          and automate tasks with ease. Currently, I am expanding my knowledge in Agentic AI, focusing on developing 
          intelligent systems that can operate autonomously, adapting and learning from data to improve decision-making 
          and performance.</p>
...
<div className='px-10 md:px-20 lg:px-40'>
 <h1 className='text-lg md:text-2xl font-bold mt-3 p-2'>About My Projects</h1>
<p className='text-justify'>In my recent web development projects, I have effectively combined HTML, CSS, Tailwind CSS, TypeScript, 
 and Next.js to craft responsive, user-friendly interfaces. By utilizing Tailwind CSS, I streamlined the 
 design process with utility-first styling, resulting in clean and maintainable code. My strong proficiency 
 in TypeScript enabled me to build reliable, bug-free applications, while JavaScript empowered me to implement
  dynamic and interactive features. A notable project was the development of a portfolio website using Next.js,
   where I integrated server-side rendering to boost both performance and SEO.
Additionally, I am proficient in Python, which I use to build robust applications and automate tasks 
efficiently. Currently, I am learning Agentic AI, exploring the development of intelligent systems that can 
autonomously learn and adapt from data to enhance decision-making and optimize performance. This diverse
 skill set allows me to contribute to both web development and AI-driven projects, delivering high-quality 
 solutions in various domains.</p>
</div>
...
<div className='grid grid-cols-1 lg:grid-cols-2 mt-5 lg:mt-10'>
  ...
  <div className='flex flex-col mt-5'>
     <h1 className="text-lg md:text-2xl font-bold ">Business & Ecommerce</h1>  
 ...
 Hackthon Ecommerce is a dynamic storefront featuring a clean layout, interactive navigation, and responsive product cards.
It includes features like category filtering, product previews, pricing information, and a user-friendly shopping experience.
The design is minimalistic yet functional, aimed at delivering a smooth browsing experience on all devices.
 Figma Assign Ecommerce is a pixel-perfect recreation of a Figma design assignment.
These projects allowed me to sharpen my skills in layout precision, spacing, font scaling, and visual hierarchy.
I followed strict design fidelity to ensure every section matched the provided UI mockups exactly.
Built with Next.js and Tailwind CSS, it highlights my strength in translating design to code while maintaining performance and responsiveness.
I also implemented reusable components and organized code to reflect best practices in frontend engineering.
Functional Hackthon is a layout-centric project that emphasizes modular design and UI reusability.
It includes structured content sections, smooth transitions, and clean component separation to aid in scalability and future updates.
This project reflects my grasp of UI composition, reusable layout patterns, and frontend optimization.
The tech stack includes React, Tailwind CSS,css, TypeScript, and Next.js, enabling fast builds and responsive behavior.
</p>
     <Link href='/'><Button className='bg-[#f03a6a] hover:bg-[#e0577c] hover:text-white duration-300
...
<div className='grid grid-cols-1 lg:grid-cols-2 mt-5 lg:mt-10'>
  ...
  <div className='flex flex-col mt-5'>
    <h1 className="text-lg md:text-2xl font-bold ">Resturant and Company Websites</h1>  
     <p className='text-justify mt-2 md:mt-4 indent-10 md:indent-20'>
...
These two sites reflect my design-to-code translation skills and understanding of modern UI principles.
Hire Developers Platform is a business-oriented landing page highlighting developer hiring services with structured CTAs.
It showcases my ability to build corporate-ready, professional layouts with a strong UX focus.
Karachi Tourist Places is a content-based city guide displaying top tourist attractions in Karachi.
It features a responsive grid, attractive visuals, and clean typography for an informative browsing experience.
All projects were built with Next.js, React, and Tailwind CSS, and deployed using Vercel.
Each site is fully responsive, mobile-friendly, and optimized for performance.
I emphasized reusable components, scalable code structure, and clean UI/UX design.
From static landing pages to dynamic content layouts, these projects demonstrate my versatility in frontend development.
They reflect my ability to work from Figma designs, implement modern frameworks, and deploy efficiently.
Collectively, these showcase my frontend expertise, design sense, and development efficiency.
</p>
     <Link href='/'><Button className='bg-[#f03a6a] hover:bg-[#e0577c] hover:text-white duration-300
 w-16 md:w-28 h-10 rounded-2xl shadow-md hover:font-bold mt-4'>Home</Button></Link>    
  </div>
...
<div className='grid grid-cols-1 lg:grid-cols-2 mt-5 lg:mt-10'>
  ...
  <div className='flex flex-col mt-5'>
     <h1 className="text-lg md:text-2xl font-bold ">Portfolio & Resume Websites</h1>  
     <p className='text-justify mt-2 md:mt-4 indent-10 md:indent-20'>
...
It’s fully responsive, performance-optimized, and designed to convert visitors into leads or clients.
...
It's a reflection of my proficiency in Python, APIs, and rapid prototyping using modern tools.
...
<div className='grid grid-cols-1 lg:grid-cols-2 mt-5 lg:mt-10'>
  ...
  <div className='flex flex-col mt-5'>
    <h1 className="text-lg md:text-2xl font-bold ">Educational Projects</h1>  
     <p className='text-justify mt-2 md:mt-4 indent-10 md:indent-20'>
Multilingual AI Agent App provides real-time language translation powered by advanced AI models.
It supports multiple languages and can seamlessly switch between them, making global communication accessible.
The app features an intuitive interface and uses Streamlit’s reactive UI for instant feedback.
Secure Data Encryption App allows users to encrypt and decrypt sensitive text data securely.
It uses Python’s cryptography libraries to implement AES encryption, ensuring data privacy.
A clean UI lets users easily input text and receive encrypted output with minimal steps.
Python Challenge Quiz App is a fun and educational platform to test Python programming knowledge.
It randomly selects coding-related questions and evaluates user input in real-time.
This app is perfect for learners to reinforce Python concepts through practice.
Python Assignment. Anagram Checker App allows users to check if two words are anagrams.
It handles edge cases like case sensitivity and space handling effectively.
This app is useful for both educational and practical scenarios in coding interviews.
All apps feature responsive layouts for desktop and mobile accessibility.
Each project is deployed on Streamlit Cloud for easy sharing and real-time use.
These apps showcase my skills in Python, Streamlit, cryptography, and AI-powered interfaces.
</p>
     <Link href='/'><Button className='bg-[#f03a6a] hover:bg-[#e0577c] hover:text-white duration-300
 w-16 md:w-28 h-10 rounded-2xl shadow-md hover:font-bold mt-4'>Home</Button></Link>    
  </div>
...
<div className='grid grid-cols-1 lg:grid-cols-2 mt-5 lg:mt-10'>
  ...
  <div className='flex flex-col mt-5'>
     <h1 className="text-lg md:text-2xl font-bold ">Utility Projects</h1>  
     <p className='text-justify mt-2 md:mt-4 indent-10 md:indent-20'>
...
<div className='grid grid-cols-1 lg:grid-cols-2 mt-5 lg:mt-10'>
  ...
  <div className='flex flex-col mt-5'>
    <h1 className="text-lg md:text-2xl font-bold ">Games and Fun</h1>  
     <p className='text-justify mt-2 md:mt-4 indent-10 md:indent-20'>
...
Image to ASCII Art Converter A unique tool that converts uploaded images into artistic ASCII text output using Python’s image 
...
Mood Analyzer An AI-powered tool that detects the user's mood based on text input using natural language processing (NLP) techniques.
